  ...
  if (appState == "run") {
    ...
    */
    ...
    function drawLowerArmWrong(ctx, shoulder, elbow, wrist) {
      ...
      drawPoint(ctx, shoulder.y * 1, shoulder.x * 1, 3, "green");
      drawPoint(ctx, wrist.y * 1, wrist.x * 1, 3, "orange");
      drawSegment([shoulder.y, shoulder.x],
      [elbow.y, elbow.x], "green", SCALE, ctx )

      drawSegment([elbow.y, elbow.x],
      [wrist.y, wrist.x], "orange", SCALE, ctx )
    }
          ...
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                ...
                <h4 class="text-lg leading-6 font-medium text-gray-900">85/100</h4>
              </div>
            </div>
          </div>
        </div>

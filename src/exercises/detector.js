...
export function runDetection(webcamRef, canvasRef, exerciseState) {
  let interval = null;
  interval = setInterval(() => {
    console.log("interval");

    detect(webcamRef, canvasRef, exerciseState);

    // }, 1000 / FPS);
  }, 500);
}

const detect = async (webcamRef, canvasRef, exerciseState) => {
  if (detector === null) {
    return;
  }
